...
const fonts = configureFonts({
	config: {
		displaySmall: { fontFamily: "RobotoSlab" },
		displayMedium: { fontFamily: "RobotoSlab" },
		displayLarge: { fontFamily: "RobotoSlab" },
		headlineSmall: { fontFamily: "RobotoSlab" },
		headlineMedium: { fontFamily: "RobotoSlab" },
		headlineLarge: { fontFamily: "RobotoSlab" },
		titleSmall: { fontFamily: "RobotoSlab" },
		titleMedium: { fontFamily: "RobotoSlab" },
		titleLarge: { fontFamily: "RobotoSlab" },
		labelSmall: { fontFamily: "RobotoSlab" },
		labelMedium: { fontFamily: "RobotoSlab" },
		labelLarge: { fontFamily: "RobotoSlab" },
		bodySmall: { fontFamily: "RobotoSlab" },
		bodyMedium: { fontFamily: "RobotoSlab" },
		bodyLarge: { fontFamily: "RobotoSlab" },
	},
});
